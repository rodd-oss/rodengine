...
mod tests {
    ...
    fn test_write_at_different_types() {
        ...
        unsafe {
            ...
            buffer.write_at::<f32>(8, 3.14159);
            buffer.write_at::<f64>(16, 2.71828);
            ...
            assert!((buffer.read_at::<f32>(8) - 3.14159).abs() < 0.0001);
            assert!((buffer.read_at::<f64>(16) - 2.71828).abs() < 0.0001);
            assert_eq!(buffer.read_at::<bool>(24), true);
            assert_eq!(buffer.read_at::<bool>(25), false);
        }
    }
    ...
    fn test_write_record_multiple_fields() {
        ...
        let score_data = 3.14159f64.to_ne_bytes();
        ...
        unsafe {
            ...
            assert!((buffer.read_at::<f64>(8) - 3.14159).abs() < 0.0001);
            assert_eq!(buffer.read_at::<bool>(16), true);
        }
    }
    ...
    fn test_write_record_partial_update() {
        ...
        let new_score_data = 2.71828f64.to_ne_bytes();
        ...
        unsafe {
            ...
            assert!((buffer.read_at::<f64>(8) - 2.71828).abs() < 0.0001); // updated
            assert_eq!(buffer.read_at::<bool>(16), true); // unchanged
        }
    }
